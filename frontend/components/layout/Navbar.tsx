        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/account/wishlist" className={`relative ${textColor} hover:text-accent transition-colors`}>
              ...
              <Link href="/cart" className={`relative ${textColor} hover:text-accent transition-colors`}>
              ...
              <Link href={isAuthenticated ? '/account' : '/auth/login'} className={`${textColor} hover:text-accent transition-colors`}>
